 ...
 * @author OHyic
 */
@WebServlet(name = "RemoveWarrantServlet", urlPatterns = {"/RemoveWarrantServlet"})
public class RemoveWarrantServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Remove warrant serlvet activated!");
    }
